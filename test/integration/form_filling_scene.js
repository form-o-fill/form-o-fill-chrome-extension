...
describe("the form filling", function() {
  ...
  describe("simple rule matching", function() {
    ...
    it("works for a rule that uses the ENV in a before function", function (done) {
      importAndExecute("Using the ENV in a before function", 'Hello ENV: {"url":{"url":"http://localhost:9292/form-o-fill-testing/13-simple.html","protocol":"http:","host":"localhost","port":"9292","path":"/form-o-fill-testing/13-simple.html","query":"","hash":""},"storage":{"base":{}}}', done);
    });
