...
describe("the form filling", function() {
  ...
  describe("simple rule matching", function() {
    ...
    it("works for a rule that uses the ENV in a before function", function (done) {
      importAndExecute("Using the ENV in a before function", 'Hello ENV: {"url":{"url":"http://localhost:8889/form-o-fill-testing/simple.html","protocol":"http:","host":"localhost","port":"8889","path":"/form-o-fill-testing/simple.html","query":"","hash":""}}', done);
    });
