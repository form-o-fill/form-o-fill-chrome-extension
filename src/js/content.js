	  ...
	  chrome.runtime.onConnect.addListener(function (port) {
	    port.onMessage.addListener(function (message) {
	      ...
	      if (message.action === "showOverlay" && typeof message.message === "undefined") {
	        _debugLogger2["default"].info("[content.js] Showing working overlay");
	      ...
	      if (message.action === "hideWorkingOverlay") {
	        _debugLogger2["default"].info("[content.js] Hiding working overlay");
	        hideOverlay();
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	!(function (a, b) {
	  ...
	  var c = [],
	    ...
	    return this.length;
	  }, n.fn.andSelf = n.fn.addBack, "function" == "function" && __webpack_require__(/*! !webpack amd options */ 3) && !(__WEBPACK_AMD_DEFINE_ARRAY__ = [], __WEBPACK_AMD_DEFINE_RESULT__ = function () {
	    return n;
