...
/***/ function(module, exports, __webpack_require__) {
	...
	function _typeof(obj) { return obj && obj.constructor === Symbol ? "symbol" : typeof obj; } /*eslint no-new-func:0, max-nested-callbacks:[1,4], complexity: 0, block-scoped-var: 0*/

	// REMOVE START
	/*eslint-disable no-undef, block-scoped-var */
	if (( false ? "undefined" : _typeof(exports)) === "object") {
	  var Utils = __webpack_require__(/*! ./utils.js */ 5);
	  var Storage = __webpack_require__(/*! ./storage.js */ 6);
	  var Rule = __webpack_require__(/*! ./rule.js */ 7);
	  ...
	  lastMatchingRules: function lastMatchingRules(rules) {
	    return new Promise(function (resolve) {
	      ...
	      if (typeof rules === "undefined") {
	        ...
	        Storage.save(_jsonf2.default.stringify(rules), Utils.keys.lastMatchingRules).then(function () {
	          resolve(true);
	        });
	      }
	    });
	  ...
	  var c = [],
	    ...
	    var c, d;if (!a) return this;if ("string" == typeof a) {
	      if ((c = "<" === a[0] && ">" === a[a.length - 1] && a.length >= 3 ? [null, a, null] : z.exec(a), !c || !c[1] && b)) return !b || b.jquery ? (b || y).find(a) : this.constructor(b).find(a);if (c[1]) {
	        if ((b = _instanceof(b, n) ? b[0] : b, n.merge(this, n.parseHTML(c[1], b && b.nodeType ? b.ownerDocument || b : l, !0)), v.test(c[1]) && n.isPlainObject(b))) for (c in b) n.isFunction(this[c]) ? this[c](b[c]) : this.attr(c, b[c]);return this;
	    ...
	    return _instanceof(this, n.Event) ? (a && a.type ? (this.originalEvent = a, this.type = a.type, this.isDefaultPrevented = a.defaultPrevented || void 0 === a.defaultPrevented && a.returnValue === !1 ? Z : $) : this.type = a, b && n.extend(this, b), this.timeStamp = a && a.timeStamp || n.now(), void (this[n.expando] = !0)) : new n.Event(a, b);
